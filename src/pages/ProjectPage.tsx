...
function generateMockChartData(project: any) {
  ...
  return months.map((label) => ({
    label,
    value: Math.floor(
      Math.random() * (project.fundingGoal * 0.3) + project.fundingGoal * 0.05,
    ),
...
export function ProjectPage() {
  ...
  const percent = calcFundingPercent(
  ...
  return (
    <>
      <div className="min-h-screen">
        ...
        <div className="px-4 md:px-8 -mt-10 md:-mt-16 relative pb-8 md:pb-12">
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              >
                ...
                <div className="flex items-center gap-3 text-sm text-text-secondary flex-wrap">
                  <Link
                    to={`/artists/${project.artistId}`}
                    className="font-medium hover:text-accent-purple-light transition-colors"
                  >
                    {artistName}
                  </Link>
                  <span>·</span>
            ...
            >
              ...
              <div className="bg-bg-card border border-border rounded-2xl p-6 sticky top-4">
                ...
                <div className="space-y-4 mb-5">
                  ...
                  <div
                    className="p-4 rounded-2xl gradient-border"
                ...
                {!isAuthenticated && project.status === "FUNDING" && (
